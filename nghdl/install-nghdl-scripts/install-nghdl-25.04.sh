...
if [ $option == "--install" ];then
    ...
    if [ -d "$ghdl" ]; then
        ...
        echo "$ghdl directory not found, skipping."
    fi
    ...
    if [ -d "$verilator" ]; then
        ...
        echo "$verilator directory not found, skipping."
    fi

    

    echo "Removing LLVM......................"
    sudo apt-get purge -y llvm llvm-dev

    echo "Removing Clang......................"
    sudo apt purge -y clang

    echo "Removing Gtk Canberra modules......................"
    sudo apt purge -y libcanberra-gtk3-module
